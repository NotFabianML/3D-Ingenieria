const WhyusCard = ({ content, title, img }: { content: string, title: string, img: string }) => (
    <div className="flex justify-start items-center flex-col px-10 py-12 max-h-[450px] max-w-[370px] md:mr-0 sm:mr-5 mr-0 my-5  bg-white border-2 border-gray-200 rounded-[20px]">
